#!/usr/bin/python3
"""
This module contains a function to divide all elements of a matrix by a given number.
The function ensures the matrix is a list of lists of integers/floats, and raises
